# Hindenburg Mobile (Expo)

Native Android/iOS client for the Hindenburg India B-Book trading platform. Talks to the same FastAPI backend as the user web frontend (`/api/v1/user/*`, `/ws/user/{id}`, `/ws/marketdata`).
