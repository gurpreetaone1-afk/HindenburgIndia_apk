...
import { formatPriceForSegment } from "@shared/utils/format";
  ...
  return (
    <Pressable onPress={onPress} style={{ flex: 1 }}>
      ...
      >
        ...
        >
          {noPrice ? "—" : formatPriceForSegment(price as number, segment)}
        </Text>
      </View>
    </Pressable>
  );
...
function BuySellBarImpl({
  ...
  return (
    ...
    >
      <SideBox kind="SELL" price={bid} segment={segment} onPress={() => fire("SELL")} />
      ...
      <SideBox kind="BUY" price={ask} segment={segment} onPress={() => fire("BUY")} />
    </View>
  );
}
